...
object Usages {
    ...
    val USB_KEY_F24 = HidUsage("USB_KEY_F24", 0x73, 194)
    val USB_KEY_LEFTCTRL = HidUsage("USB_KEY_LEFTCTRL", 0xE0, 29)
    val USB_KEY_LEFTSHIFT = HidUsage("USB_KEY_LEFTSHIFT", 0xE1, 42)
    val USB_KEY_LEFTALT = HidUsage("USB_KEY_LEFTALT", 0xE2, 56)
    val USB_KEY_LEFTMETA = HidUsage("USB_KEY_LEFTMETA", 0xE3, 125)
    val USB_KEY_RIGHTCTRL = HidUsage("USB_KEY_RIGHTCTRL", 0xE4, 97)
    val USB_KEY_RIGHTSHIFT = HidUsage("USB_KEY_RIGHTSHIFT", 0xE5, 54)
    val USB_KEY_RIGHTALT = HidUsage("USB_KEY_RIGHTALT", 0xE6, 100)
    val USB_KEY_RIGHTMETA = HidUsage("USB_KEY_RIGHTMETA", 0xE7, 126)
